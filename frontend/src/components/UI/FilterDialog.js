...
export const FilterDialog = () => { 
  ...
  const selectedLabel = "peer-checked:text-black font-semibold"
    ...
    return (
        <>
        <button className="mr-2 mb-2 px-3 py-1 border rounded bg-white shadow-md mt-6" onClick={openModalHandler}>Filter <TuneIcon /></button>
        <dialog ref={dialog} className='justify-center items-center z-10 rounded-md overflow-scroll h-80'>
            <div className='flex items-center justify-between'>
                <h2 className='text-xl font-bold ml-2'>Filter</h2>
