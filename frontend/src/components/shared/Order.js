...
export const Order = () => {
    ...
    const orderHandler = async (e) => {
        ...
        try {
            const checkoutResponse = await fetchWithAuth(`${process.env.REACT_APP_SERVER_URL}/order/checkout`, {
                method: 'POST',
                headers: {
            ...
            const options = {
                ...
                handler: async (response) => {
                    try {
                        const orderResult = await fetchWithAuth(`${process.env.REACT_APP_SERVER_URL}/order/place`, {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                            },
